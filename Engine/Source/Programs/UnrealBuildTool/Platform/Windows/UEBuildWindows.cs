...
namespace UnrealBuildTool
{
	...
	public class WindowsTargetRules
	{
		...
		/// </summary>
		public int TargetWindowsVersion = 0x0A00;
...
//			}
		...
		public override void SetUpEnvironment(ReadOnlyTargetRules Target, CppCompileEnvironment CompileEnvironment, LinkEnvironment LinkEnvironment)
		{
			...
			{
				CompileEnvironment.Definitions.Add(String.Format("_WIN32_WINNT=0x{0:X4}", 0x0A00));
				CompileEnvironment.Definitions.Add(String.Format("WINVER=0x{0:X4}", 0x0A00));
