		...
		protected virtual string GetCLArguments_Global(CppCompileEnvironment CompileEnvironment)
		{
			...
			if (CompileEnvironment.Architecture.StartsWith("x86_64"))
			{
				...
				if (CompileEnvironment.bUseAVX)
				{
					...
					//Result += "-mavx2 -mfma";
					//Result += "-march=broadwell -mtune=broadwell -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
					//Result += "-march=core-avx2 -mtune=core-avx2 -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
					//Result += "-march=znver3 -mtune=znver3 -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";

					switch (CompileEnvironment.DefaultCPU)
					{
						case DefaultCPUVersion.Native:
							Result += "-march=native -mtune=native -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Haswell:
							Result += "-march=haswell -mtune=haswell -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Broadwell:
							Result += "-march=broadwell -mtune=broadwell -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Skylake:
							Result += "-march=skylake -mtune=skylake -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Alderlake:
							Result += "-march=alderlake -mtune=alderlake -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Bdver4:
							Result += "-march=bdver4 -mtune=bdver4 -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Znver1:
							Result += "-march=znver1 -mtune=znver1 -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Znver2:
							Result += "-march=znver2 -mtune=znver2 -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Znver3:
							Result += "-march=znver3 -mtune=znver3 -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Knl:
							Result += "-march=knl -mtune=knl -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Knm:
							Result += "-march=knm -mtune=knm -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Skylake_avx512:
							Result += "-march=skylake-avx512 -mtune=skylake-avx512 -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Cannonlake:
							Result += "-march=cannonlake -mtune=cannonlake -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Icelake_client:
							Result += "-march=icelake-client -mtune=icelake-client -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Icelake_server:
							Result += "-march=icelake-server -mtune=icelake-server -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Cascadelake:
							Result += "-march=cascadelake -mtune=cascadelake -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Cooperlake:
							Result += "-march=cooperlake -mtune=cooperlake -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Tigerlake:
							Result += "-march=tigerlake -mtune=tigerlake -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Sapphirerapids:
							Result += "-march=sapphirerapids -mtune=sapphirerapids -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						case DefaultCPUVersion.Alderlake_avx512:
						case DefaultCPUVersion.Rocketlake:
							Result += "-march=rocketlake -mtune=rocketlake -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
						default:
							Result += "-march=haswell -mtune=haswell -Xclang -mprefer-vector-width=256 -mllvm -force-vector-width=8 -mllvm -force-vector-interleave=4";
							break;
					...
					Result += "-DPLATFORM_ENABLE_VECTORINTRINSICS=1";
					Result += "-DPLATFORM_MAYBE_HAS_SSE4_1=1";
					Result += "-DPLATFORM_ALWAYS_HAS_SSE4_1=1";
					Result += "-DPLATFORM_MAYBE_HAS_AVX=1";
					Result += "-DPLATFORM_ALWAYS_HAS_AVX=1";
					Result += "-DPLATFORM_MAYBE_HAS_AVX_2=1";
					Result += "-DPLATFORM_ALWAYS_HAS_AVX_2=1";
					Result += "-DPLATFORM_ALWAYS_HAS_FMA3=1";
				}
				else
				{
					//Result += "-march=westmere -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";

					switch (CompileEnvironment.DefaultCPU)
					{
						case DefaultCPUVersion.Native:
							Result += "-march=native -mtune=native -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Nehalem:
							Result += "-march=nehalem -mtune=nehalem -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Westmere:
							Result += "-march=westmere -mtune=westmere -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Sandybridge:
							Result += "-march=sandybridge -mtune=sandybridge -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Ivybridge:
							Result += "-march=ivybridge -mtune=ivybridge -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Silvermont:
							Result += "-march=silvermont -mtune=silvermont -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Goldmont:
							Result += "-march=goldmont -mtune=goldmont -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Goldmont_plus:
							Result += "-march=goldmont-plus -mtune=goldmont-plus -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Tremont:
							Result += "-march=tremont -mtune=tremont -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Btver2:
							Result += "-march=btver2 -mtune=btver2 -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Bdver1:
							Result += "-march=bdver1 -mtune=bdver1 -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Bdver2:
							Result += "-march=bdver2 -mtune=bdver2 -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						case DefaultCPUVersion.Bdver3:
							Result += "-march=bdver3 -mtune=bdver3 -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
						default:
							Result += "-march=nehalem -mtune=nehalem -Xclang -mprefer-vector-width=128 -mllvm -force-vector-width=4 -mllvm -force-vector-interleave=2";
							break;
				...
				{
					Result += "-DPLATFORM_FAVOR_INTEL=1";
				}
				...
				{
					Result += "-DPLATFORM_FAVOR_AMD=1";
				}

				// This matches Intel oneAPI clang compiler
				//if (CompilerVersionMajor >= new int(202110))
				//{
				//	Result += "-DPLATFORM_MAYBE_HAS_SVML=1";
				//	Result += "-DPLATFORM_ALWAYS_HAS_SVML=1";
				//}
			}
