...
bool LoadCudaDriverFunctions(void* library, CUDA_DRIVER_API_FUNCTION_LIST* funcList)
{
	...
	funcList->cuDeviceGetUuid_v2 = (PFNCUDEVICEGETUUIDV2)(FPlatformProcess::GetDllExport(library, TEXT("cuDeviceGetUuid_v2"))); // NEW
	...
	funcList->cuFlushGPUDirectRDMAWrites = (PFNCUFLUSHGPUDIRECTRDMAWRITES)(FPlatformProcess::GetDllExport(library, TEXT("cuFlushGPUDirectRDMAWrites"))); // NEW
	...
	funcList->cuDeviceGetExecAffinitySupport = (PFNCUDEVICEGETEXECAFFINITYSUPPORT)(FPlatformProcess::GetDllExport(library, TEXT("cuDeviceGetExecAffinitySupport"))); // NEW
	...
	funcList->cuCtxCreate_v3 = (PFNCUCTXCREATEV3)(FPlatformProcess::GetDllExport(library, TEXT("cuCtxCreate_v3"))); // NEW
	...
	funcList->cuCtxGetExecAffinity = (PFNCUCTXGETEXECAFFINITY)(FPlatformProcess::GetDllExport(library, TEXT("cuCtxGetExecAffinity"))); // NEW
	...
	funcList->cuArrayGetMemoryRequirements = (PFNCUARRAYGETMEMORYREQUERIMENTS)(FPlatformProcess::GetDllExport(library, TEXT("cuArrayGetMemoryRequirements"))); // NEW
	funcList->cuMipmappedArrayGetMemoryRequirements = (PFNCUMIPMAPPEDARRAYGETMEMORYREQUERIMENTS)(FPlatformProcess::GetDllExport(library, TEXT("cuMipmappedArrayGetMemoryRequirements"))); // NEW
	...
	funcList->cuStreamGetCaptureInfo_v2 = (PFNCUSTREAMGETCAPTUREINFOV2)(FPlatformProcess::GetDllExport(library, TEXT("cuStreamGetCaptureInfo_v2"))); // NEW
	funcList->cuStreamUpdateCaptureDependencies = (PFNCUSTREAMUPDATECAPTUREDEPENDENCIES)(FPlatformProcess::GetDllExport(library, TEXT("cuStreamUpdateCaptureDependencies"))); // NEW
	...
	funcList->cuStreamWaitValue32_v2 = (PFNCUSTREAMWAITVALUE32V2)(FPlatformProcess::GetDllExport(library, TEXT("cuStreamWaitValue32_v2"))); // NEW
	funcList->cuStreamWaitValue64_v2 = (PFNCUSTREAMWAITVALUE64V2)(FPlatformProcess::GetDllExport(library, TEXT("cuStreamWaitValue64_v2"))); // NEW
	funcList->cuStreamWriteValue32_v2 = (PFNCUSTREAMWRITEVALUE32V2)(FPlatformProcess::GetDllExport(library, TEXT("cuStreamWriteValue32_v2"))); // NEW
	funcList->cuStreamWriteValue64_v2 = (PFNCUSTREAMWRITEVALUE64V2)(FPlatformProcess::GetDllExport(library, TEXT("cuStreamWriteValue64_v2"))); // NEW
	funcList->cuStreamBatchMemOp_v2 = (PFNCUSTREAMBATCHMEMOPV2)(FPlatformProcess::GetDllExport(library, TEXT("cuStreamBatchMemOp_v2"))); // NEW
	...
	funcList->cuGraphAddBatchMemOpNode = (PFNCUGRAPHADDBATCHMEMOPNODE)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphAddBatchMemOpNode"))); // NEW
	funcList->cuGraphBatchMemOpNodeGetParams = (PFNCUGRAPHBATCHMEMOPNODEGETPARASM)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphBatchMemOpNodeGetParams"))); // NEW
	funcList->cuGraphBatchMemOpNodeSetParams = (PFNCUGRAPHBATCHMEMOPNODESETPARAMS)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphBatchMemOpNodeSetParams"))); // NEW
	funcList->cuGraphExecBatchMemOpNodeSetParams = (PFNCUGRAPHEXECBATCHMEMOPNODESETPARAMS)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphExecBatchMemOpNodeSetParams"))); // NEW
	funcList->cuGraphAddMemAllocNode = (PFNCUGRAPHADDMEMALLOCNODE)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphAddMemAllocNode"))); // NEW
	funcList->cuGraphMemAllocNodeGetParams = (PFNCUGRAPHMEMALLOCNODEGETPARAMS)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphMemAllocNodeGetParams"))); // NEW
	funcList->cuGraphAddMemFreeNode = (PFNCUGRAPHADDMEMFREENODE)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphAddMemFreeNode"))); // NEW
	funcList->cuGraphMemFreeNodeGetParams = (PFNCUGRAPHMEMFREENODEGETPARAMS)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphMemFreeNodeGetParams"))); // NEW
	funcList->cuDeviceGraphMemTrim = (PFNCUDEVICEGRAPHMEMTRIM)(FPlatformProcess::GetDllExport(library, TEXT("cuDeviceGraphMemTrim"))); // NEW
	funcList->cuDeviceGetGraphMemAttribute = (PFNCUDEVICEGETGRAPHMEMATTRIBUTE)(FPlatformProcess::GetDllExport(library, TEXT("cuDeviceGetGraphMemAttribute"))); // NEW
	funcList->cuDeviceSetGraphMemAttribute = (PFNCUDEVICESETGRAPHMEMATTRIBUTE)(FPlatformProcess::GetDllExport(library, TEXT("cuDeviceSetGraphMemAttribute"))); // NEW
	...
	funcList->cuGraphInstantiateWithFlags = (PFNCUGRAPHINSTANTIATEWITHFLAGS)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphInstantiateWithFlags"))); // NEW
	...
	funcList->cuGraphNodeSetEnabled = (PFNCUGRAPHNODESETENABLED)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphNodeSetEnabled"))); // NEW
	funcList->cuGraphNodeGetEnabled = (PFNCUGRAPHNODEGETENABLED)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphNodeGetEnabled"))); // NEW
	...
	funcList->cuGraphDebugDotPrint = (PFNCUGRAPHDEBUGDOTPRINT)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphDebugDotPrint"))); // NEW
	funcList->cuUserObjectCreate = (PFNCUGRAPHUSEROBJECTCREATE)(FPlatformProcess::GetDllExport(library, TEXT("cuUserObjectCreate"))); // NEW
	funcList->cuUserObjectRetain = (PFNCUGRAPHUSEROBJECTRETAIN)(FPlatformProcess::GetDllExport(library, TEXT("cuUserObjectRetain"))); // NEW
	funcList->cuUserObjectRelease = (PFNCUGRAPHUSEROBJECTRETLEASE)(FPlatformProcess::GetDllExport(library, TEXT("cuUserObjectRelease"))); // NEW
	funcList->cuGraphRetainUserObject = (PFNCUGRAPHRETAINUSEROBJECT)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphRetainUserObject"))); // NEW
	funcList->cuGraphReleaseUserObject = (PFNCUGRAPHRELEASEUSEROBJECT)(FPlatformProcess::GetDllExport(library, TEXT("cuGraphReleaseUserObject"))); // NEW
	...
	funcList->cuGetProcAddress = (PFNCUGETPROCADDRESS)(FPlatformProcess::GetDllExport(library, TEXT("cuGetProcAddress"))); // NEW
	funcList->cuModuleGetLoadingMode = (PFNCUGETLOADINGMODE)(FPlatformProcess::GetDllExport(library, TEXT("cuModuleGetLoadingMode"))); // NEW
	funcList->cuMemGetHandleForAddressRange = (PFNCUGETHANDLEFORADDRESSRANGE)(FPlatformProcess::GetDllExport(library, TEXT("cuMemGetHandleForAddressRange"))); // NEW
