...
#if defined(PLATFORM_ALWAYS_HAS_CUDA) && (PLATFORM_ALWAYS_HAS_CUDA >= 1)
#ifndef UE_PLATFORM_MATH_USE_CUDA
#define UE_PLATFORM_MATH_USE_CUDA 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_CUDA
#define UE_PLATFORM_MATH_USE_CUDA 0
#endif
#endif

#if defined(PLATFORM_ALWAYS_HAS_HIP) && (PLATFORM_ALWAYS_HAS_HIP >= 1)
#ifndef UE_PLATFORM_MATH_USE_HIP
#define UE_PLATFORM_MATH_USE_HIP 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_HIP
#define UE_PLATFORM_MATH_USE_HIP 0
#endif
#endif

#if defined(PLATFORM_ALWAYS_HAS_SYCL) && (PLATFORM_ALWAYS_HAS_SYCL >= 1)
#ifndef UE_PLATFORM_MATH_USE_SYCL
#define UE_PLATFORM_MATH_USE_SYCL 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_SYCL
#define UE_PLATFORM_MATH_USE_SYCL 0
#endif
#endif

#if defined(PLATFORM_ALWAYS_HAS_OPENCL) && (PLATFORM_ALWAYS_HAS_OPENCL >= 1)
#ifndef UE_PLATFORM_MATH_USE_OPENCL
#define UE_PLATFORM_MATH_USE_OPENCL 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_OPENCL
#define UE_PLATFORM_MATH_USE_OPENCL 0
#endif
#endif

#if defined(PLATFORM_ALWAYS_HAS_VULKAN) && (PLATFORM_ALWAYS_HAS_VULKAN >= 1)
#ifndef UE_PLATFORM_MATH_USE_VULKAN
#define UE_PLATFORM_MATH_USE_VULKAN 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_VULKAN
#define UE_PLATFORM_MATH_USE_VULKAN 0
#endif
#endif

#if defined(PLATFORM_MAC) && defined(PLATFORM_ALWAYS_HAS_METAL) && (PLATFORM_ALWAYS_HAS_METAL >= 1)
#ifndef UE_PLATFORM_MATH_USE_METAL
#define UE_PLATFORM_MATH_USE_METAL 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_METAL
#define UE_PLATFORM_MATH_USE_METAL 0
#endif
#endif

#if defined(PLATFORM_WINDOWS) && defined(PLATFORM_ALWAYS_HAS_D3D12) && (PLATFORM_ALWAYS_HAS_D3D12 >= 1)
#ifndef UE_PLATFORM_MATH_USE_D3D12
#define UE_PLATFORM_MATH_USE_D3D12 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_D3D12
#define UE_PLATFORM_MATH_USE_D3D12 0
#endif
#endif

#if defined(PLATFORM_WINDOWS) && defined(PLATFORM_ALWAYS_HAS_DIRECTML) && (PLATFORM_ALWAYS_HAS_DIRECTML >= 1)
#ifndef UE_PLATFORM_MATH_USE_DIRECTML
#define UE_PLATFORM_MATH_USE_DIRECTML 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_DIRECTML
#define UE_PLATFORM_MATH_USE_DIRECTML 0
#endif
#endif

#if defined(PLATFORM_WINDOWS) && defined(PLATFORM_ALWAYS_HAS_WINML) && (PLATFORM_ALWAYS_HAS_WINML >= 1)
#ifndef UE_PLATFORM_MATH_USE_WINML
#define UE_PLATFORM_MATH_USE_WINML 1
#endif
#else
#ifndef UE_PLATFORM_MATH_USE_WINML
#define UE_PLATFORM_MATH_USE_WINML 0
#endif
#endif
...
#ifndef UE_PLATFORM_MATH_USE_SSE4_2
#define UE_PLATFORM_MATH_USE_SSE4_2			PLATFORM_ALWAYS_HAS_SSE4_2
#endif
