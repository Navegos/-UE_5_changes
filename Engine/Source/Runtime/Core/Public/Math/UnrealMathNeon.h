...
#if !defined(PLATFORM_WINDOWS) && (defined(PLATFORM_ALWAYS_HAS_SYCL) && (PLATFORM_ALWAYS_HAS_SYCL >= 1))
...
#if !defined(PLATFORM_WINDOWS) && (defined(PLATFORM_ALWAYS_HAS_OPENCL) && (PLATFORM_ALWAYS_HAS_OPENCL >= 1))
...
#if !defined(PLATFORM_WINDOWS) && (defined(PLATFORM_ALWAYS_HAS_VULKAN) && (PLATFORM_ALWAYS_HAS_VULKAN >= 1))
...
#if (defined(PLATFORM_IOS) || defined(PLATFORM_TVOS)) && (defined(PLATFORM_ALWAYS_HAS_METAL) && (PLATFORM_ALWAYS_HAS_METAL >= 1))
