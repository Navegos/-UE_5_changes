...
private:
	...
	static LPVOID WINAPI	VmAlloc2(HANDLE Process, PVOID BaseAddress, SIZE_T Size, ULONG AllocationType, ULONG PageProtection, MEM_EXTENDED_PARAMETER*  /*void**/ ExtendedParameters, ULONG ParameterCount);
