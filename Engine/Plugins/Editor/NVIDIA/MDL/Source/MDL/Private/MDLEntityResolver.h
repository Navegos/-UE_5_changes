...
public:
    ...
    virtual char const *get_mdl_file_path_mask() const;
    ...
    virtual char const *get_filename_mask() const;
    ...
    virtual char const *get_mdl_file_path(mi::Size i) const;
    ...
    virtual char const *get_filename(mi::Size i) const;
