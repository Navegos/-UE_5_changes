...
struct FCastFloat
{
	...
	inline float operator()(UE::Shader::EValueComponentType Type, const UE::Shader::FValueComponent& Component) const
	{
		switch (Type)
		{
		case UE::Shader::EValueComponentType::Float: return Component.Float;
		case UE::Shader::EValueComponentType::Double: return (float)Component.Double;
		case UE::Shader::EValueComponentType::Int: return (float)Component.Int;
		case UE::Shader::EValueComponentType::Bool: return (float)Component.Bool;
		default: return 0.0f;
		}
	}
};
...
struct FCastDouble
{
	...
	inline double operator()(UE::Shader::EValueComponentType Type, const UE::Shader::FValueComponent& Component) const
	{
		switch (Type)
		{
		case UE::Shader::EValueComponentType::Float: return (double)Component.Float;
		case UE::Shader::EValueComponentType::Double: return Component.Double;
		case UE::Shader::EValueComponentType::Int: return (double)Component.Int;
		case UE::Shader::EValueComponentType::Bool: return (double)Component.Bool;
		default: return 0.0f;
		}
	}
};
...
struct FCastInt
{
	...
	inline int32 operator()(UE::Shader::EValueComponentType Type, const UE::Shader::FValueComponent& Component) const
	{
		switch (Type)
		{
		case UE::Shader::EValueComponentType::Float: return (int32)Component.Float;
		case UE::Shader::EValueComponentType::Double: return (int32)Component.Double;
		case UE::Shader::EValueComponentType::Int: return Component.Int;
		case UE::Shader::EValueComponentType::Bool: return Component.Bool ? 1 : 0;
...
struct FCastBool
{
	...
	inline bool operator()(UE::Shader::EValueComponentType Type, const UE::Shader::FValueComponent& Component) const
	{
		switch (Type)
		{
		case UE::Shader::EValueComponentType::Float: return Component.Float != 0.0f;
		case UE::Shader::EValueComponentType::Double: return Component.Double != 0.0;
		case UE::Shader::EValueComponentType::Int: return Component.Int != 0;
		case UE::Shader::EValueComponentType::Bool: return Component.AsBool();
		default: return false;
		}
	}
};
...
void CastValue(const Operation& Op, const UE::Shader::FValue& Value, ResultType& OutResult)
{
	using FComponentType = typename Operation::FComponentType;
	const int32 NumComponents = Value.NumComponents;
	const UE::Shader::EValueComponentType ComponentType = Value.ComponentType;
	if (NumComponents == 1)
	{
...
{
	FFloatValue Result;
	CastValue(FCastFloat(), *this, Result);
	return Result;
}
...
{
	FDoubleValue Result;
	CastValue(FCastDouble(), *this, Result);
	return Result;
}
